    ...
    return (
        <>
            <div className="navbar border-radius-top-3">
                <div className="logo animate-character"><a onClick={() => { navigate("/") }}>KitKart</a></div>
                {/* Search */}
                    ...
                    {userId !== null
                        ...
                        <div className="grocify-button-container login-btn">
                            <button className="grocify-button grocify-button-primary" onClick={() => { navigate('/login') }}>
                                ...
                                <a href="http://localhost:3001/reactjs/login" className="grocify-button grocify-button-primary admin" target="_blank">Admin Login</a>
                        </div>
                    }
                </div>
            </div>
